...
public enum NodePlatform {
    ...
    public static NodePlatform fromMcef(MCEFPlatform platform) {
        if (platform == null) {
            throw new IllegalStateException("MCEF did not recognize this Node runtime platform");
        }
    ...
    public static NodePlatform detect(String osName, String architecture) {
        ...
        if (!arm64 && !x64) {
            throw new IllegalStateException("Unsupported Node runtime architecture: " + architecture);
        }
        ...
        throw new IllegalStateException("Unsupported Node runtime operating system: " + osName);
    }
}
