...
public record NodeRuntimeDescriptor(
    ...
    private static final Map<NodePlatform, NodeRuntimeDescriptor> DESCRIPTORS = createDescriptors();
    ...
    public static NodeRuntimeDescriptor current() {
        return forPlatform(NodePlatform.current());
    }

    public static NodeRuntimeDescriptor forPlatform(NodePlatform platform) {
    ...
    public static Map<NodePlatform, NodeRuntimeDescriptor> all() {
    ...
    private static Map<NodePlatform, NodeRuntimeDescriptor> createDescriptors() {
        Map<NodePlatform, NodeRuntimeDescriptor> values = new EnumMap<>(NodePlatform.class);
        values.put(NodePlatform.WINDOWS_X64, archive(
        ...
        values.put(NodePlatform.WINDOWS_ARM64, archive(
                NodePlatform.WINDOWS_ARM64,
        ...
        values.put(NodePlatform.MACOS_X64, archive(
        ...
        values.put(NodePlatform.MACOS_ARM64, archive(
                NodePlatform.MACOS_ARM64,
        ...
        values.put(NodePlatform.LINUX_X64, archive(
        ...
        values.put(NodePlatform.LINUX_ARM64, archive(
                NodePlatform.LINUX_ARM64,
