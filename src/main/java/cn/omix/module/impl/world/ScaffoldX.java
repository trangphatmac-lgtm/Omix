...
import cn.omix.util.player.BlockUtil;
import cn.omix.util.player.FallingPlayer;
...
/**
 * ScaffoldX and clutch implementation adapted to the Omix event/rotation stack.
 * Core behaviour is based on OpenSSNGScaffoldAndClutch (MIT, Copyright 2026 Un4nown).
 */
@Getter
public final class ScaffoldX extends Module {
    ...
    public ScaffoldX() {
        super("ScaffoldX", Category.World);
    }

    @Override
    public void onEnable() {
        ScaffoldMutex.activate(getModule(Scaffold.class));
