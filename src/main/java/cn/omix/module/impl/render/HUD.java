...
import cn.omix.util.misc.RomanNumeralUtil;
...
public class HUD extends Module {
    ...
    public final MultiBoolValue hudOptionsProperty = new MultiBoolValue("HUD Options", () -> hudMode.is("Omix"),
    ...
    private final BoolValue noPotionIcons = new BoolValue("No Potion Icons", true, () -> hudMode.is("Omix"));
    private final BoolValue whiteMode = new BoolValue("White Mode", false, () -> hudMode.is("Omix"));
