...
public final class Chams extends Module {
    ...
    private static final RenderPipeline TINT_THROUGH_WALLS_PIPELINE = RenderPipelines.register(
            RenderPipeline.builder(RenderPipelines.ENTITY_SNIPPET)
                    .withLocation(Identifier.of("omix", "pipeline/chams_tint_through_walls"))
    ...
    private static final RenderLayer FLAT_LAYER = createFlatLayer("omix_chams_flat", FLAT_PIPELINE);
    private static final RenderLayer FLAT_THROUGH_WALLS_LAYER = createFlatLayer("omix_chams_flat_through_walls", FLAT_THROUGH_WALLS_PIPELINE);
    ...
    private static RenderPipeline createFlatPipeline(String name, boolean throughWalls) {
        RenderPipeline.Builder builder = RenderPipeline.builder(RenderPipelines.TRANSFORMS_AND_PROJECTION_SNIPPET)
                .withLocation(Identifier.of("omix", "pipeline/" + name))
                .withVertexShader(Identifier.of("omix", "core/chams_flat"))
                .withFragmentShader(Identifier.of("omix", "core/chams_flat"))
                .withBlend(BlendFunction.TRANSLUCENT)
                .withCull(false)
                .withDepthWrite(false)
    ...
    private static RenderLayer createTintThroughWallsLayer(Identifier texture) {
        RenderSetup setup = RenderSetup.builder(TINT_THROUGH_WALLS_PIPELINE)
                ...
                .translucent()
                .build();
        return RenderLayer.of("omix_chams_tint_through_walls", setup);
    }
}
