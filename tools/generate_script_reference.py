...
for name in ['README.md','common-knowledge.md','game-tools.md','lifecycle.md','api-guide.md','custom-tools.md','packet-module-control.md','modes.md','tools.md','mcp.md','api.json','mode-hosts.json']:
